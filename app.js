  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="900" height="900">
    <defs>
      <radialGradient id="g" cx="30%" cy="20%" r="90%">
        <stop offset="0" stop-color="#4B1630"/>
        <stop offset="1" stop-color="#240A16"/>
      </radialGradient>
    </defs>
    <rect width="100%" height="100%" fill="url(#g)"/>
    <text x="50%" y="48%" dominant-baseline="middle" text-anchor="middle"
      font-family="-apple-system,Segoe UI,Arial" font-size="44" fill="rgba(255,255,255,.86)" font-weight="800">${escapeHTML(title)}</text>
    <text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle"
      font-family="-apple-system,Segoe UI,Arial" font-size="26" fill="rgba(255,255,255,.55)">Fotoğraf yok</text>
  </svg>`;
}
...
/* Background Music (iOS için buton şart) */
